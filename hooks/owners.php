<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'owners' table. 
	...
	*/
	...
	function owners_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function owners_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function owners_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['pass'], $data['level'], $data['image']
	...
	*/
	...
	function owners_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['name'], $data['pass'], $data['level'], $data['image']
	...
	*/
	...
	function owners_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['pass'], $data['level'], $data['image']
	...
	*/
	...
	function owners_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['name'], $data['pass'], $data['level'], $data['image']
	...
	*/
	...
	function owners_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function owners_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function owners_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function owners_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function owners_csv($query, $memberInfo, $args){
