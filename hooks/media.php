<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'media' table. 
	...
	*/
	...
	function media_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function media_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function media_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['type'], $data['title'], $data['artist'], $data['condition'], $data['image'], $data['image2'], $data['price'], $data['active'], $data['description'], $data['buttoncode'], $data['buttonactive']
	...
	*/
	...
	function media_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['type'], $data['title'], $data['artist'], $data['condition'], $data['image'], $data['image2'], $data['price'], $data['active'], $data['description'], $data['buttoncode'], $data['buttonactive'], $data['owner'], $data['ip'], $data['date']
	...
	*/
	...
	function media_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['type'], $data['title'], $data['artist'], $data['condition'], $data['image'], $data['image2'], $data['price'], $data['active'], $data['description'], $data['buttoncode'], $data['buttonactive']
	...
	*/
	...
	function media_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['type'], $data['title'], $data['artist'], $data['condition'], $data['image'], $data['image2'], $data['price'], $data['active'], $data['description'], $data['buttoncode'], $data['buttonactive'], $data['owner'], $data['ip'], $data['date']
	...
	*/
	...
	function media_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function media_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function media_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function media_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function media_csv($query, $memberInfo, $args){
