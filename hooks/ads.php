<?php
	...
	*/
	 ...
	 *     $data['advertiser'], $data['adName'], $data['image'], $data['code'], $data['text'], $data['active'], $data['StartDate'], $data['EndDate'], $data['catagory']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['advertiser'], $data['adName'], $data['image'], $data['code'], $data['text'], $data['active'], $data['StartDate'], $data['EndDate'], $data['catagory']
