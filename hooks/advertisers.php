<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'advertisers' table. 
	...
	*/
	...
	function advertisers_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function advertisers_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function advertisers_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['Name'], $data['AffilateCode'], $data['URL'], $data['Contact'], $data['email']
	...
	*/
	...
	function advertisers_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function advertisers_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['Name'], $data['AffilateCode'], $data['URL'], $data['Contact'], $data['email']
	...
	*/
	...
	function advertisers_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function advertisers_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function advertisers_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function advertisers_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function advertisers_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function advertisers_csv($query, $memberInfo, $args){
