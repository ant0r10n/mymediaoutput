...
<!-- filters header -->
<div class="row hidden-sm hidden-xs" style="border-bottom: solid 2px #DDD; background-color: #EEE;">
...
<?php
	for($i = 1; $i <= (3 * $FiltersPerGroup); $i++){ // Number of filters allowed
		...
		if(($i % $FiltersPerGroup == 1) && $i != 1){
			...
			<div class="row FilterSet<?php echo ($i - 1); ?>" style="border-bottom: dotted 1px #DDD; background-color: #EEE">
...
<!-- sorting header  -->   
<div class="row" style="border-bottom: solid 2px #DDD; background-color: #EEE;">
...
<?php
	...
	if(!$isAnonymous){
		?>
		<!-- ownership header  --> 
		<div class="row filterByOwnership" style="border-bottom: solid 2px #DDD; background-color: #EEE;">
