	...
	<table class="table table-striped">
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="adminUsername" value="<?php echo htmlspecialchars($adminConfig['adminUsername']); ?>" size="20" class="formTextBox">
				</td>
			</tr>
		<tr>
			<td align="right" class="tdFormCaption" valign="top">
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="senderName" value="<?php echo htmlspecialchars($adminConfig['senderName']); ?>" size="40" class="formTextBox">
				</td>
			</tr>
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="custom1" value="<?php echo htmlspecialchars($adminConfig['custom1']); ?>" size="20" class="formTextBox">
				</td>
			</tr>
		<tr>
			<td align="right" class="tdFormCaption" valign="top">
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="custom2" value="<?php echo htmlspecialchars($adminConfig['custom2']); ?>" size="20" class="formTextBox">
				</td>
			</tr>
		<tr>
			<td align="right" class="tdFormCaption" valign="top">
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="custom3" value="<?php echo htmlspecialchars($adminConfig['custom3']); ?>" size="20" class="formTextBox">
				</td>
			</tr>
		<tr>
			<td align="right" class="tdFormCaption" valign="top">
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="custom4" value="<?php echo htmlspecialchars($adminConfig['custom4']); ?>" size="20" class="formTextBox">
				</td>
			</tr>
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="approvalSubject" value="<?php echo htmlspecialchars($adminConfig['approvalSubject']); ?>" size="40" class="formTextBox">
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="MySQLDateFormat" value="<?php echo htmlspecialchars($adminConfig['MySQLDateFormat']); ?>" size="30" class="formTextBox">
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="PHPDateFormat" value="<?php echo htmlspecialchars($adminConfig['PHPDateFormat']); ?>" size="30" class="formTextBox">
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="PHPDateTimeFormat" value="<?php echo htmlspecialchars($adminConfig['PHPDateTimeFormat']); ?>" size="30" class="formTextBox">
				<br />Please refer to <a href="http://www.php.net/manual/en/function.date.php" target="_blank">the PHP manual</a> for possible formats. 
				</td>
			</tr>
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="groupsPerPage" value="<?php echo htmlspecialchars($adminConfig['groupsPerPage']); ?>" size="5" class="formTextBox">
				</td>
			</tr>
		<tr>
			<td align="right" class="tdFormCaption" valign="top">
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="membersPerPage" value="<?php echo intval($adminConfig['membersPerPage']); ?>" size="5" class="formTextBox">
				</td>
			</tr>
		<tr>
			<td align="right" class="tdFormCaption" valign="top">
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="recordsPerPage" value="<?php echo intval($adminConfig['recordsPerPage']); ?>" size="5" class="formTextBox">
				</td>
			</tr>
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="anonymousGroup" value="<?php echo htmlspecialchars($adminConfig['anonymousGroup']); ?>" size="30" class="formTextBox">
				</td>
			</tr>
		...
		<tr>
			...
			<td align="left" class="tdFormInput">
				<input type="text" name="anonymousMember" value="<?php echo htmlspecialchars($adminConfig['anonymousMember']); ?>" size="30" class="formTextBox">
				</td>
			</tr>
